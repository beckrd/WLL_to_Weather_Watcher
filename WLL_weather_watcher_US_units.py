...
#
# This version is set up for US units, 
# to change to all SI units, the bucket factor will need to be changed(?)
#
...
# write current.txt (current conditions for indi)		
		...
		temp_str = "temperature="+ str(round(temp, 2)) + "\n"
		file1.write(temp_str)
		temp_str = "Humidity="+ str(humidity) + "\n"
		file1.write(temp_str)
		temp_str = "Wind="+ str(round(wind_speed, 2)) + "\n"
		file1.write(temp_str)
		temp_str = "Rain=" + str(round(rain_rate, 2)) + "\n"
		file1.write(temp_str)
		temp_str = "Pressure=" + str(round(pressure, 2)) + "\n"
		file1.write(temp_str)
		file1.close()
